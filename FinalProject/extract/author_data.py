...
# Init param
store_path = '../data/sample_authors@1.1.csv'
columns = ['author', 'commits_number','bug_commits_number','total_fix_distance', 'total_find_bug_time', 'total_fix_bug_time']
bug_fixes = json.load(open('../data/prepare_data/all_fix_bug_commits@202006220401.json', 'r'))
authors = json.load(open('../data/prepare_data/all_author@202006220401.json', 'r'))
samples = pd.read_csv('../data/prepare_data/sample_author@1.1.csv', index_col=None)
# Init DataFrame
